package kz.bitlab.minio.service;

import io.minio.GetObjectArgs;
import io.minio.MinioClient;
import io.minio.PutObjectArgs;
import kz.bitlab.minio.dto.AttachmentFileDto;
import kz.bitlab.minio.mapper.AttachmentFileMapper;
import kz.bitlab.minio.model.AttachmentFile;
import kz.bitlab.minio.repository.AttachmentFileRepository;
...
public class FileService {
    ...
    public String uploadFile(MultipartFile file) {
        ...
        String fileName = convertToSha1("Snega" + attachmentFile.getId() + "_");
